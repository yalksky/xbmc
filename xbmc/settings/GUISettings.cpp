...
//  AddGroup(1, 0);
  ...
  AddDefaultAddon(ml, "musiclibrary.albumsscraper", 20193, "metadata.albums.daum.net", ADDON_SCRAPER_ALBUMS);
  AddDefaultAddon(ml, "musiclibrary.artistsscraper", 20194, "metadata.artists.daum.net", ADDON_SCRAPER_ARTISTS);
